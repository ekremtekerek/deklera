 ...
 *     wp-content/plugins/deklera/tests/seed.php
 *
 * @package Deklera
 */
 ...
 * @return void
 */
function deklera_seed_tax_rate( string $country, string $rate, string $name ): void {
	global $wpdb;
 ...
 * @return int
 */
function deklera_seed_product( string $name, string $price, bool $virtual ): int {
 ...
 * @return int
 */
function deklera_seed_order( int $product_id, int $quantity, array $billing, array $meta = array() ): int {
...
deklera_seed_tax_rate( 'FR', '20.0000', 'TVA' );

$goods   = deklera_seed_product( 'Deklera Test Widget', '100', false );
$service = deklera_seed_product( 'Deklera Test Ebook', '50', true );

$created = array();

// 1. Yurt ici FR B2C - KDV %20 uygulanir, temiz olmali.
$created['FR B2C yurt ici'] = deklera_seed_order(
	$goods,
	2,
	array(
		'first_name' => 'Camille',
...
$created['DE B2B mal, KDV no var'] = deklera_seed_order(
	$goods,
	1,
	array(
		'first_name' => 'Jonas',
...
$created['DE B2B mal, KDV no YOK'] = deklera_seed_order(
	$goods,
	1,
	array(
		'first_name' => 'Lena',
...
$created['NL B2B hizmet'] = deklera_seed_order(
	$service,
	1,
	array(
		'first_name' => 'Sanne',

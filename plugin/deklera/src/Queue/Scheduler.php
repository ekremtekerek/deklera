...
final class Scheduler {
	 ...
	 * Kuyruk kancası.
	 */
	public const HOOK = 'deklera_generate_document';
	 ...
	 */
	public const HOOK_CREDIT_NOTE = 'deklera_generate_credit_note';
	...
	public static function enqueue( int $order_id ): void {
		 ...
		 * @param int  $order_id Sipariş kimliği.
		 */
		if ( ! \apply_filters( 'deklera/should_generate', true, $order_id ) ) {
			return;
		}

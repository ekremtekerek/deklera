...
namespace Deklera\Queue;

use Deklera\Invoice\Profile;
use Deklera\Ksef\RejectedByKsef;
use Deklera\Ksef\Submission;
...
final class KsefQueue {
	 ...
	 * Gönderim kancası.
	 */
	public const HOOK = 'deklera_submit_to_ksef';

	/**
	 * Kuyruk grubu.
	 */
	public const GROUP = 'deklera';
	...
	public static function register(): void {
		 ...
		 * teslim edilir.
		 */
		\add_action( 'deklera/document_generated', array( self::class, 'on_document_generated' ), 10, 1 );
	}
	...
	private static function seller_nip(): string {
		$vat = (string) \get_option( 'deklera_seller_vat_number', '' );

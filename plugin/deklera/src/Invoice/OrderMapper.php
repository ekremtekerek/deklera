...
final class OrderMapper {
	...
	public static function map( \WC_Order $order ): SemanticInvoice {
		 ...
		 * @param \WC_Order $order  Sipariş.
		 */
		$number = (string) \apply_filters( 'deklera/invoice_number', (string) $order->get_order_number(), $order );
	...
	public static function vat_number( \WC_Order $order ): string {
		 ...
		 * @param \WC_Order $order Sipariş.
		 */
		return (string) \apply_filters( 'deklera/buyer_vat_number', $found, $order );
	}

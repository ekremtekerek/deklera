...
final class Freemius {
	 ...
	 * WP_FS__deklera_SECRET_KEY sabitinde durur.
	 */
	...
	public static function instance(): ?object {
		...
		$sdk = \dirname( \Deklera\PLUGIN_FILE ) . '/vendor/freemius/wordpress-sdk/start.php';
		 ...
		 * hook and remove the file"). Mantik Deklera\Uninstall'da.
		 */
		self::$instance->add_action( 'after_uninstall', array( \Deklera\Uninstall::class, 'cleanup' ) );

		/*
		 * SDK'nin yuklendigini bildirir; Freemius bunu bekler.
		 */
		\do_action( 'deklera_fs_loaded' );

...
final class Database {
	 ...
	 */
	private const OPTION = 'deklera_db_version';
	...
	public static function documents_table(): string {
		...
		return $wpdb->prefix . 'deklera_documents';
	}
	...
	public static function audit_table(): string {
		...
		return $wpdb->prefix . 'deklera_audit';
	}
	...
	public static function install(): void {
		...
		\dbDelta(
			"CREATE TABLE {$docs} (
				...
				ksef_session varchar(64) NOT NULL DEFAULT '',
				ksef_reference varchar(64) NOT NULL DEFAULT '',
				...
				KEY ksef_reference (ksef_reference),

...
final class Retention {
	 ...
	 */
	public const HOOK = 'deklera_prune_archive';
	 ...
	 */
	public const OPTION_ENABLED = 'deklera_retention_prune_enabled';
	...
	public static function schedule(): void {
		...
		if ( \as_has_scheduled_action( self::HOOK, array(), 'deklera' ) ) {
			return;
		}

		\as_schedule_recurring_action( time() + DAY_IN_SECONDS, DAY_IN_SECONDS, self::HOOK, array(), 'deklera' );
	}
	...
	public static function years(): int {
		 ...
		 * @param int $years Yıl.
		 */
		return max( 1, (int) \apply_filters( 'deklera/retention_years', self::DEFAULT_YEARS ) );
	}
